...
if not check_lock():
    ...
    def abrir_explorador():
        if no_factura.get() != "" and no_pedimento.get() != "" and codigo_impo.get() != "" and codigo_proveedor.get()!="":
            opciones = {
            ...
            if archivo != "" :
                create(archivo, nombre, no_pedimento.get(), no_factura.get().upper(),codigo_impo.get().upper(),codigo_proveedor.get().upper(),set_focus_on_entry)
                clear_entry()
